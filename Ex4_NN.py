...
def checkNNGradients(lamda):
    ...
    #print('numgrad 19:',numgrad[19])
    #print('grad 19:', grad[19])
...
def ex4_NN():  # main function
    ...
    print('Cost at (fixed) debugging parameters (w/ lambda =):',lmbda)
    print('(for lambda = 3, this value should be about 0.576051)',  debug_J[0]);
    ...
    x3=np.array([ X[imageNo]])   
    p=predict(Theta1,Theta2, x3) # mat['X'])
    print('p:',p)
    print('y:',y[imageNo])
